export default function BtnAgendar() {
  return (
    <a
      href="https://wa.me/5599999999999?text=Quero%20agendar%20um%20corte%20na%20régua!"
      target="_blank"
      rel="noopener noreferrer"
      className="mt-4 inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 transition-colors text-white font-light px-4 py-2 rounded shadow"
    >
      {/* Ícone WhatsApp SVG */}
      <svg
